...
public class StoreLinksYio {
    ...
    private void createProLinks() {
        ...
        proLinks.put("android_kladom", "https://play.google.com/store/apps/details?id=yio.tro.kladom_pro");
    ...
    private void createIosLinks() {
        ...
        iosLinks.put("kladom", "https://apps.apple.com/app/vodobanka/id1644158249");
    }
    ...
    private void createAndroidLinks() {
        ...
        androidLinks.put("shproty", "https://play.google.com/store/apps/details?id=yio.tro.shproty");
        androidLinks.put("shotakoe", "https://play.google.com/store/apps/details?id=yio.tro.shotakoe");
        androidLinks.put("kladom", "https://play.google.com/store/apps/details?id=yio.tro.kladom");
    }
